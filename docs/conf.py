...
# -*- coding: utf-8 -*-
#
# spotifylib documentation build configuration file, created by
...
sphinx.apidoc.main(argv=['_','-f', '-o', os.path.join(project_root, 'docs'),
                   os.path.join(project_root, '''spotifylib''')])
...
project = u'''spotifylib'''
copyright = u'''2017, (Author : Oriol Fabregas)'''
...
version = spotifylib.__version__
# The full version, including alpha/beta/rc tags.
release = spotifylib.__version__
...
htmlhelp_basename = '''spotifylibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''spotifylib.tex''',
     u'''spotifylib Documentation''',
     u'''Oriol Fabregas''', 'manual'),
]
